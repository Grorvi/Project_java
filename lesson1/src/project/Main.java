...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Chocolate chocolate1 = new Chocolate("Шоколад", 150, 50);
        Chocolate chocolate2 = new Chocolate("Шоколад1", 300, 100);
        ...
        ChocolateVendingMachine machine1 = new ChocolateVendingMachine(products);

        Chocolate chocolateRes = machine1.getChocolate("Шоколад1", 100);
        if (bottleOfWaterRes != null) {
            System.out.println("Вы купили: ");
